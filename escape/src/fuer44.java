 ...
 * @author  __USER__
 */
public class fuer44 extends javax.swing.JFrame {

	/** Creates new form fuer44 */
	public fuer44() {
		initComponents();
	...
	void load() throws UnknownHostException, IOException,
		...
		for (int i = events.size() - 1; i < events.size(); i++) {
			this.jTextArea1.setText(events.get(i - 18).getContent());
		}
	...
	private void initComponents() {
		...
		jScrollPane1.setBounds(170, 320, 420, 130);
