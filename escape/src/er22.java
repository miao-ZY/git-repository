 ...
 * @author  __USER__
 */
public class er22 extends javax.swing.JFrame {

	/** Creates new form er22 */
	public er22() {
		initComponents();
	...
	void load() throws UnknownHostException, IOException,
		...
		for (int i = events.size() - 1; i < events.size(); i++) {
			this.jTextArea1.setText(events.get(i - 5).getContent());
		}
	...
	private void initComponents() {
		...
		jScrollPane1.setBounds(190, 330, 410, 130);
