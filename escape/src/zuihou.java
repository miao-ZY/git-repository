...
/*
 ...
 import Model.beijing;* zuihou.java
 *
 ...
 * @author  __USER__
 */
public class zuihou extends javax.swing.JFrame {

	/** Creates new form zuihou */
	public zuihou() {
		initComponents();
	...
	void load() throws UnknownHostException, IOException,
		...
		jieju u = new jieju();
		ArrayList<jieju> jiejus = u.viewData4();
		Object detail[][] = new Object[jiejus.size()][1];
		int i;
		String e;
		...
		if (i < 6) {
			...
			this.jTextArea1.setText(jiejus.get(a).getGcontent());
			a = a + 1;
			c = String.valueOf(a);
	...
	void load1() throws UnknownHostException, IOException,
		...
		ArrayList<jieju> jiejus = u.viewData4();
		Object detail[][] = new Object[jiejus.size()][1];
		for (int i = jiejus.size() - 1; i < jiejus.size(); i++) {
			this.jTextArea1.setText(jiejus.get(i - 6).getGcontent());
		}
