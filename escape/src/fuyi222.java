 ...
 * @author  __USER__
 */
public class fuyi222 extends javax.swing.JFrame {

	/** Creates new form fuyi222 */
	public fuyi222() {
		initComponents();
	...
	void load() throws UnknownHostException, IOException,
		...
		for (int i = events.size() - 1; i < events.size(); i++) {
			this.jTextArea1.setText(events.get(i - 9).getContent());
		}
	...
	private void initComponents() {
		...
		jScrollPane1.setBounds(140, 310, 450, 140);
