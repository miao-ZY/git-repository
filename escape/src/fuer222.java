 ...
 * @author  __USER__
 */
public class fuer222 extends javax.swing.JFrame {

	/** Creates new form fuer222 */
	public fuer222() {
		initComponents();
	...
	void load() throws UnknownHostException, IOException,
		...
		for (int i = events.size() - 1; i < events.size(); i++) {
			this.jTextArea1.setText(events.get(i - 14).getContent());
		}
	...
	private void initComponents() {
		...
		jButton2.setBounds(557, 410, 50, 25);
		...
		jScrollPane1.setBounds(170, 291, 450, 150);
