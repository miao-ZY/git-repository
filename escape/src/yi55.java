 ...
 * @author  __USER__
 */
public class yi55 extends javax.swing.JFrame {

	/** Creates new form yi55 */
	public yi55() {
		initComponents();
	...
	void load() throws UnknownHostException, IOException,
		...
		for (int i = events.size() - 1; i < events.size(); i++) {
			this.jTextArea1.setText(events.get(i - 7).getContent());
		}
	...
	private void initComponents() {
		...
		jButton2.setBounds(527, 420, 50, 25);
		...
		jScrollPane1.setBounds(170, 320, 430, 130);
