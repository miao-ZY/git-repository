 ...
 * @author  __USER__
 */
public class zuihou2 extends javax.swing.JFrame {

	/** Creates new form zuihou2 */
	public zuihou2() {
		initComponents();
	...
	void load() throws UnknownHostException, IOException,
		...
		jieju2 u = new jieju2();
		ArrayList<jieju2> jieju2s = u.viewData5();
		Object detail[][] = new Object[jieju2s.size()][1];
		int i;
		String e;
		...
		if (i < 7) {
			...
			this.jTextArea1.setText(jieju2s.get(a).getGcontent());
			a = a + 1;
			c = String.valueOf(a);
...
ArrayList<jieju2> jieju2s = u.viewData5();
Object detail[][] = new Object[jieju2s.size()][1];
for (int i = jieju2s.size() - 1; i < jieju2s.size(); i++) {
	this.jTextArea1.setText(jieju2s.get(i - 6).getGcontent());
}
